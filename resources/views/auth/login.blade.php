                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="loginForm" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group form-check">
                                <input type="hidden" name="keep_logged_in" value="0">
                                <input type="checkbox" class="form-check-input" id="keepLoggedIn" name="keep_logged_in">
                                <label class="form-check-label" for="keepLoggedIn">{{ __('Mantener sesión abierta') }}</label>
                            </div>
